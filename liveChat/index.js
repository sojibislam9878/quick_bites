...
app.use(cors(
    {
        origin: [, "http://localhost:300", 'http://localhost:300'],
...
async function run() {
    ...
    try {
        ...
        app.post('/payment-success', async (req, res) => {
            ...
            res.status(200).redirect(`http://localhost:300/transaction/${data.tran_id}`);
        });
        ...
        app.post('/payment-cancel', async (req, res) => {
            ...
            res.status(200).redirect('http://localhost:300');
