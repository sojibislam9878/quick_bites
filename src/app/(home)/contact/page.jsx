        ...
        <div className=" pt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
            <div className="flex items-center gap-4 p-2 bg-[#FFFFFF] rounded-lg">
              <div className="text-white bg-gradient-to-r from-[#F29F42] to-[#F07751] p-5 text-xl rounded-xl">
                <FaPhoneAlt />
              </div>
              <div>
            ...
            <div className="flex items-center gap-4 p-2 bg-[#FFFFFF] rounded-lg">
              <div className="text-white bg-gradient-to-r from-[#F29F42] to-[#F07751] p-4 text-2xl rounded-xl">
                <MdEmail />
              </div>
              <div>
            ...
            <div className="container mx-auto p-4 bg-white rounded-xl mt-16 ">
              ...
              <div className="text-center ">
                ...
                <p className="leading-7 opacity-80 mt-6 lg:w-2/3 mx-auto">
                  Your brige to meaningful commuication and personalized
                  assistance, we are here to listen and assist you.
                </p>
              </div>
              <div className="flex lg:flex-row md:flex-col">
                <div className="p-4 rounded-xl mt-10 flex-1">
                  ...
                  <button className="btn w-full bg-[#EA6A12] hover:bg-[#C75A0F] text-white">
                    ...
                    {/* map  */}
                <div className="flex-1 overflow-hidden mt-16 h-[25rem]">
                <GoogleMap></GoogleMap>
                </div>
              </div>
            </div>
