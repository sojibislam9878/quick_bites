...
const DiscountBanner = () => {
    ...
    return (
        <div className='grid grid-cols-1  md:grid-cols-2 my-4 gap-8  rounded-xl overflow-hidden'>
            ...
            <div className='relative overflow-hidden max-w-xl rounded-xl shadow-lg group'>
                <Image
                    ...
                    width={565}
                    height={200}
                    className='bg-cover inset-0 w-full h-[250px]'
                />
                ...
                <div className='absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-t from-black/60 to-transparent text-white p-4'>
                    <h2 className="text-4xl text-white font-bold  text-center mb-4 hover:scale-x-125 duration-200" >
                        50% Off for First Order
                    </h2>
                    {/* Countdown Timer Display */}

                    <div className='flex flex-row justify-center items-center gap-2'>
                        <div className="  text-white rounded px-2 py-2 text-4xl font-bold"> <MdOutlineWatchLater />
                        </div>
            ...
            < div className='relative overflow-hidden max-w-xl rounded-xl shadow-lg group' >
                <Image
                    ...
                    width={565}
                    height={200}
                    className='bg-cover inset-0 w-full h-[250px] bg-center bg-no-repeat'
                />
                <div className='absolute inset-0 flex flex-col  justify-center items-center  bg-gradient-to-t from-black/60 to-transparent text-white p-4'>
                    <h2 className="text-4xl font-bold hover:scale-x-125 duration-200">
                        Free Delivery
                    </h2>
