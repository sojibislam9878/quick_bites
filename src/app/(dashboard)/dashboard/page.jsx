...
const DashboardPage = () => {
  ...
  return (
    <div> <div className="min-h-screen flex justify-center items-center p-4 lg:p-0">
      ...
      <div className="bg-white shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] text-[#533831] selection:text-orange-500 rounded-lg p-8 w-full">
